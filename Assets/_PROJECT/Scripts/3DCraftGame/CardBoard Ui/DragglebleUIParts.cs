...
namespace CraftGame
{
    ...
    public class DragglebleUIParts : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler,
        IDragHandler
    {
        ...
        public void SetPartNumbers(int numbers)
        {
            _numberOfParts = numbers;
        }
